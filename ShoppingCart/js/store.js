...
function store() {
    this.products = [
        new product("Zomb0", "Zombie 1", "Eat one every day to keep the doctor away!", 12, 90, 0, 2, 0, 1, 2),
        new product("Zomb1", "Zombie 1", "Guacamole anyone?", 16, 90, 0, 1, 1, 1, 2),
        new product("Zomb2", "Zombie 1", "These are rich in Potassium and easy to peel.", 4, 120, 0, 2, 1, 2, 2),
        new product("Zomb3", "Zombie 1", "Delicious and refreshing.", 3, 50, 4, 4, 1, 2, 0),
